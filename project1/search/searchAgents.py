...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        space)
        """
        # Create a list of corners, they will be removed from list as visited
        goalList = list(self.corners)
        return (self.startingPosition, goalList)

    def isGoalState(self, state):
        """
        Returns whether this search state is a goal state of the problem.
        """
        # Check if all corners in goalList have been visited.
        # If any objects still in list, return False
        goalList = state[1]
        if not len(goalList) == 0:
            return False
        return True
